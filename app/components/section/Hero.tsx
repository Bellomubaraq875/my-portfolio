...
const HeroSection = () => {
    ...
    const codeSnippet = [
        ...
        "};",
        "",
        "function shipProduct(idea) {",
        "  return scalableSolution(idea);",
        "}",
    ];
                ...
                <div className="flex flex-col items-start order-2 lg:order-1">
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="flex items-start gap-6 max-w-md border-l border-white/10 pl-8">
                        <p className="text-white/40 text-lg font-light leading-relaxed font-sans">
                            Senior Frontend Engineer with <span className="text-white font-medium">5+ years</span> of experience crafting high-performance, visually refined digital products.
                        </p>
                    </motion.div>

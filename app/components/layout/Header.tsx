        ...
        const handleScroll = () => {
            ...
            for (const section of sections) {
                ...
                if (element) {
                    ...
                    // Adjust threshold (150) to trigger highlight when section hits top
                        ...
                        {navItems.map((item, idx) => (
                            ...
                            >
                                <Link
                                    ...
                                    className={`text-xs font-black uppercase tracking-[0.5em] transition-colors ${activeSection === item.href.substring(1) ? "text-port-sky" : "text-white/40"
                                        }`}
                                >
                                    {item.name}
                                </Link>
